...
from detection_utils import split_image, merge_predictions
...
def main():
    ...
    image_path = r"./images/hair_test_live_2.jpg"
    ...
    # Save result
    cv2.imwrite('output_full_test.jpg', image)
