...
from detection_utils import remove_overlapping_boxes, draw_boxes, get_box_centers

from laser_handler import LaserInterface
from galvo_handler import GalvoInterface
from calibration_utils import save_transformation_to_file, read_transformation_from_file,calculate_homography, transform_to_mover_coordinates
    ...
    def update_frame(self):
        ...
        if self.im_frame is not None:
            ...
            if self.isDetectionOn.get() == 1:
                ...
                self_detection_centers = get_box_centers(self.detection_boxes)
